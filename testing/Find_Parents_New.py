...
obo_url="/data/yihengzhu/GOA/resource/benchmark/go-basic.obo"
...
if __name__=="__main__":
    ...
    find_parents_from_file(resultfile, resultfile + "_new", obo_dict)
    sort_result(resultfile)
    sort_result(resultfile + "_new")
